class Aplicacion {
    ...
    crearTarjetaDeRestaurante(restaurant){
        let self = this;
    ...
    calificarRestaurant(restaurant){
        let self = this;
    ...
    reservarUnHorario(restaurant, horario){
    ...
    cargarOpcionDefault(idFiltro, defecto){
